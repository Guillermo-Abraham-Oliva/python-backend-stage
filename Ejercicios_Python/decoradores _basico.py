...
'''
1️⃣ El decorador es 'decorador_1' → Es la función que recibe otra función → 'función_que_se_esta_decorando', en este caso 'saludar', y la modifica. En un entorno profesional USAR SIEMPRE EL MISMO CONMBRE DE → funcion_original
