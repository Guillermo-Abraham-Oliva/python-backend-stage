"""
Este programa permite al usuario eliminar todas las letras de una lista predefinida de letras. 
La lista conserva sus modificaciones a lo largo de la ejecución del programa, permitiendo que el usuario continúe trabajando con la lista actualizada en cada iteración. Utiliza validaciones robustas y manejo de excepciones para prevenir errores y permite al usuario decidir si quiere seguir interactuando.
"""
    ...
    while True:  # Bucle para validar la entrada del usuario
        ...
        try:
            ...
            if len(letra_a_borrar) != 1 or not letra_a_borrar.isalpha():
                ...
                raise ValueError('\t\tDebes ingresar solo 1 letra válida.')  
